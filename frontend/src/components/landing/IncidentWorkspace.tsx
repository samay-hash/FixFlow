import { AlertTriangle, ChevronDown, MoreHorizontal, ArrowRight, CircleAlert, Check } from 'lucide-react';
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-5">
              ...
              <div className="grid gap-4 md:grid-cols-[1.2fr_0.75fr_0.75fr]">
                ...
                <div className="rounded-2xl border border-slate-100 p-4">
                  ...
                  <div className="mb-4 flex items-center gap-2 text-[12px] font-extrabold text-slate-700"><StatusDot color="bg-red-500" /> Investigating</div>
                  <p className="text-[11px] font-bold text-slate-500">Owner</p>
                  <div className="my-2 flex items-center gap-2 text-[12px] font-extrabold text-slate-700">
                    <img 
                      src="/avatars/maya.png" 
                      alt="Maya Chen" 
                      className="h-7 w-7 rounded-full object-cover border border-slate-100 shadow-sm" 
                    />
                    Maya Chen
                  </div>
            ...
            <div className="grid gap-4">
              <div className="rounded-2xl border border-slate-200 bg-white p-5">
                <div className="mb-5 flex items-center gap-3">
                  <span className="flex h-10 w-10 items-center justify-center rounded-2xl bg-white border border-slate-100 shadow-sm">
                    <img src="/logos/slack.svg" alt="Slack" className="h-6 w-6 object-contain" />
                  </span>
                ...
                <div className="mt-2 flex items-center gap-2 text-[13px] font-black text-[#07111f]"><CircleAlert size={16} className="text-red-500" /> Incident triggered</div>
