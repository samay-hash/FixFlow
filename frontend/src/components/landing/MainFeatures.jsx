    ...
    return (
      <div className="mt-8 rounded-2xl border border-slate-200 bg-white p-5">
        <div className="mb-5 flex items-center gap-2 text-[12px] font-extrabold text-[#07111f]">
          ...
          <span className="ml-auto flex items-center gap-1 text-[11px] text-emerald-600"><StatusDot /> Live</span>
        </div>
        {[
      ...
      <div className="mt-8 rounded-2xl border border-slate-200 bg-white p-5">
        ...
        <div className="mb-4 rounded-2xl border border-slate-200 bg-white p-4">
          <div className="mb-2 flex items-center gap-2 text-[12px] font-extrabold text-[#07111f]">
            <GitBranch size={18} /> GitHub Deploy
          </div>
...
export function MainFeatures() {
  return (
    <section id="product" className="relative bg-[#fffaf5] px-6 py-24 scroll-mt-24">
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="grid gap-6 lg:grid-cols-3">
          {FEATURE_CARDS.map(({ icon: Icon, tint, title, desc }, index) => (
