...
export function Pricing() {
  return (
    <section id="pricing" className="relative overflow-hidden bg-[#fffaf5] px-6 py-24 scroll-mt-24">
      <div className="absolute -left-28 top-0 h-72 w-72 opacity-30"><CurveField /></div>
      <div className="mx-auto max-w-6xl">
        <div className="mb-10 text-center">
          <p className="mx-auto mb-5 inline-flex rounded-full border border-orange-200 bg-white px-8 py-3 text-[14px] font-black text-slate-700">Simple, transparent pricing</p>
