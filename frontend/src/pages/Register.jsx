      ...
      <div className="w-full max-w-md">
        ...
        <div className="mb-6">
          <div
            ...
            style={{ background: '#0A0A0A', boxShadow: '4px 4px 0 #FF8C42' }}
          >
            <span className="text-lg font-black uppercase tracking-widest text-white">FixFlow</span>
            <span className="text-xs font-bold px-1.5 py-0.5" style={{ background: '#FF8C42', color: '#0A0A0A' }}>AI</span>
          </div>
        ...
        >
          ...
          <p className="text-center text-sm font-medium mt-4" style={{ color: '#555' }}>
            ...
            <a href="/login" className="font-bold" style={{ color: '#A0C4FF', textDecoration: 'underline' }}>
              Sign in →
            </a>
          </p>
        </div>
        ...
        <div className="mt-4 grid grid-cols-3 gap-2">
          {[
            { label: 'Real-time Alerts', bg: '#FF8C42', color: '#0A0A0A' },
            { label: 'AI Postmortems',   bg: '#A0C4FF', color: '#0A0A0A' },
